...
public class ConsoleCommandColors : ConsoleCommand
{
    ...
    public override void ExecuteCommand(Console console, string[] args)
    {
        ...
        {
            console.SetTextColor(new Color32(Convert.ToByte(args[1].Substring(0, 2), 16), Convert.ToByte(args[1].Substring(2, 2), 16), Convert.ToByte(args[1].Substring(4, 2), 16), byte.MaxValue));
            console.SetBackgroundColor(new Color32(Convert.ToByte(args[2].Substring(0, 2), 16), Convert.ToByte(args[2].Substring(2, 2), 16), Convert.ToByte(args[2].Substring(4, 2), 16), byte.MaxValue));
        }
