...
///   -> Set the script's Axis to MouseY in the inspector. (You want the camera to tilt up and down like a head. The character already turns.)
	...
	var strafespeedX:float = 30;
	var strafespeedZ:float = 30;
    ...
    function Update ()
    {
        ...
        if (Input.GetAxis("Vertical"))
        {
            ...
            transform.localPosition += cameraReference.transform.localRotation * Vector3(0,0,translationZ/strafespeedX);
        }
        ...
        if (Input.GetAxis("Horizontal"))
        {
            ...
            transform.localPosition += cameraReference.transform.localRotation * Vector3(translationX/strafespeedZ,0,0);
        }       
