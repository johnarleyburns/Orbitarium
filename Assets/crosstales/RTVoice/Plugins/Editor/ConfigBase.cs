...
namespace Crosstales.RTVoice.EditorExt
{
    ...
    public abstract class ConfigBase : EditorWindow
    {
        ...
        protected static void save()
        {
            ...
            //EditorPrefs.SetString(Constants.KEY_TTS_WINDOWS_EDITOR, Constants.TTS_WINDOWS_EDITOR);
            //EditorPrefs.SetString(Constants.KEY_TTS_WINDOWS_EDITOR_x86, Constants.TTS_WINDOWS_EDITOR_x86);
            //EditorPrefs.SetBool(Constants.KEY_ENFORCE_32BIT_WINDOWS, Constants.ENFORCE_32BIT_WINDOWS);
            //EditorPrefs.SetString(Constants.KEY_TTS_MACOS, Constants.TTS_MACOS);
