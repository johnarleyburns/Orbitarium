 ...
 * 
 * On-line documentation: <a href="http://nbodyphysics.com/GravityEngine.pdf">GravityEngine.pdf</a>
 *
 * Support forums: <a href="http://nbodyphysics.com/blog/forums/">forums</a>
 */
	...
	public void SetAlgorithm(Algorithm algorithm) {
		...
		switch(algorithm) {
			...
			case Algorithm.HERMITE8:
				integrator = new HermiteIntegrator();
				break;
